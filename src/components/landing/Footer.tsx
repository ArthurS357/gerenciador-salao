            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-8 md:px-16 pt-14 pb-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 pb-10 border-b border-[rgba(197,168,124,0.1)]">
                    ...
                    <nav aria-label="Links do rodapé" className="flex gap-8 md:gap-10">
                        {[
                            ...
                            <a
                                key={label}
                                href={href}
                                className="text-[0.68rem] font-medium tracking-[0.18em] uppercase text-white/30 transition-colors duration-200 hover:text-caramelo/80"
                            >
                                {label}
                            </a>
                        ))}
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2.5 px-5 py-2.5 border border-[rgba(197,168,124,0.2)] rounded-sm text-[0.68rem] font-medium tracking-[0.15em] uppercase text-caramelo/65 transition-all duration-300 hover:border-[rgba(197,168,124,0.45)] hover:text-caramelo hover:bg-[rgba(197,168,124,0.05)]"
                    >
