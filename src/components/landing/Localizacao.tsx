...
const InfoItem = memo(function InfoItem({
    ...
    return (
        <div className="flex items-start gap-5">
            <div className="flex items-center justify-center w-10 h-10 flex-shrink-0 border border-[rgba(197,168,124,0.25)] bg-[rgba(197,168,124,0.05)] text-marrom-claro">
                {icone}
            </div>
            <div>
                <h4 className="font-sans text-[0.65rem] font-semibold tracking-[0.2em] uppercase text-marrom-medio mb-1.5">{titulo}</h4>
                {children}
            </div>
        </div>
    )
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-start">
                    ...
                    <div>
                        ...
                        <h2 className="font-serif text-[2.2rem] md:text-[3rem] font-light text-[#2a1810] mb-3 leading-[1.1] tracking-[-0.01em]">
                            Visite o
                            <em className="block italic text-marrom-claro not-italic font-semibold">Nosso Espaço</em>
                        </h2>
                            ...
                            >
                                <div className="flex flex-col gap-1.5">
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 text-[0.88rem] text-[#6b4c3b] hover:text-marrom-claro transition-colors"
                                        aria-label="WhatsApp"
                                    >
                                        (11) 94796-9025
                        ...
                        >
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="text-caramelo">
