...
const Navbar = memo(function Navbar({ sessao }: NavbarProps) {
    return (
        <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between py-5 px-6 md:px-16 bg-creme/[0.92] backdrop-blur-md border-b border-caramelo/20">
            <Link href="#" className="font-serif text-2xl font-semibold text-marrom-profundo tracking-[0.02em] no-underline">
                LmLu Mattielo
